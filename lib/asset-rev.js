...
var FastbootManifestRewrite = require('broccoli-asset-rev/lib/fastboot-manifest-rewrite');
...
function AssetRev(inputTree, options) {
  ...
  this.digestAlgorithm = options.digestAlgorithm || defaults.digestAlgorithm;
